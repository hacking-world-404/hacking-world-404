...
os.system('clear')
print(f' WIFI PROXY SYSTEM ON...... ')
os.system('espeak -a 300 " wifi proxy system on"')
try:
    import requests 
except ImportError:
...
os.system('espeak -a 300 " SYSTEM LOGIN,  TO,  MR,  ANIK  CYBER V I P,  HACKING TOOLS"')
...
{G}▐▌ ▐▌ █  ▗▄█▄▖▐▌ ▐▌    ▗▞▘▝▚▖▝▚▄▄▖
──────────────────────────────────────────────────
{R}[{A}●{R}]{G} TIK TOK          {R}[{A}●{R}]{G} HACKING WORLD
{R}[{A}●{R}]{G} OWNER             {R}[{A}●{R}]{G} HACKING WORLD
{R}[{A}●{R}]{G} TOOLS             {R}[{A}●{R}]{G} HACK CLONE V.1-2 
──────────────────────────────────────────────────"""
...
def menu():   
    os.system('espeak -a 300 " WELLCOME,  TO,  MR,  DARK  CYBER V I P,  TOOLS"')
    clear()
    print(f'{R}[{A}1{R}]{G} 𝙋𝙃𝙊𝙉𝙀 𝙁𝘼𝘾𝙏𝙊𝙍𝙔 𝙁𝙇𝘼𝙎𝙃')
    print(f'{R}[{A}2{R}]{G} 𝙒𝙄𝙁𝙄 𝙃𝘼𝘾𝙆𝙄𝙉𝙂')
    print(f'{R}[{A}3{R}]{G} 𝘾𝘾 𝙏𝙑 𝘾𝘼𝙈𝙀𝙍𝘼 𝙃𝘼𝘾𝙆')
    print(f'{R}[{A}4{R}]{G} 𝙄𝙈𝙊 𝙃𝘼𝘾𝙆')
    linex()
